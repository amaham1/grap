...
// Import Heroicons
import { CalendarIcon, MapPinIcon, UserGroupIcon, ExclamationTriangleIcon, DocumentMagnifyingGlassIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <section id={id} className="py-8 first:pt-4 last:pb-0 scroll-mt-20">
      <div className="flex justify-between items-center mb-4">
        ...
        {count > 0 && (
          <Link href={`/alljeju/${type === 'exhibition' ? 'external-exhibitions' : type === 'welfare' ? 'welfare-services' : type === 'jeju' ? 'jeju-events' : ''}`}
